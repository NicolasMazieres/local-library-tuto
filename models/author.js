...
AuthorSchema.virtual("lifespan").get(function() {
  return DateTime.fromJSDate(this.date_of_birth).toLocaleString(DateTime.DATE_SHORT)+" - "+DateTime.fromJSDate(this.date_of_death).toLocaleString(DateTime.DATE_SHORT);
});
